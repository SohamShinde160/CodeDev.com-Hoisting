...
const Sidebar = () => {
  ...
  return (
    <div className=" text-richblack-50 font-semibold bg-richblack-800">
      <div
      ...
      >
        ...
        <div className="flex font-semibold flex-col">
          ...
          <button
            ...
            className="text-sm font-semibold text-richblack-300 mx-4 my-4"
          >
      ...
      <div className="flex lg:hidden fixed bottom-0 justify-between items-center px-2 py-1 bg-richblack-900 z-50 w-full">
        <div className="flex flex-row gap-1 w-full justify-between">
          ...
          <button
            ...
            className="text-sm font-semibold text-richblack-300 mx-4"
          >
          <VscSignOut className="text-3xl text-richblack-25" />
          </button>
        </div>
      </div>
