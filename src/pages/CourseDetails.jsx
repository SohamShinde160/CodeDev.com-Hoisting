...
function CourseDetails() {
  ...
  return (
    <>
      <div className={`relative w-full font-semibold bg-richblack-800`}>
        {/* Hero Section */}
      ...
      <div className="mx-auto box-content px-4 text-start text-richblack-5 lg:w-[1260px]">
        <div className="mx-auto max-w-maxContentTab lg:mx-0 xl:max-w-[810px]">
          ...
          <div className="my-8 border border-richblack-600 p-8">
            ...
            <div className="mt-5">
              <p className="font-semibold">{whatYouWillLearn}</p>
            </div>
          </div>

          {/* Tags */}
          <div className="flex flex-col mb-10 lg:flex-row gap-4">
          ...
          <div className="max-w-[830px] font-semibold">
